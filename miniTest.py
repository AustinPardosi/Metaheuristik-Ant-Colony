...
print("Banyak Data Total", len(dataTotalIterationColony))
for data in dataTotalIterationColony:
    print(data)
...
print("Lokasi data Hasil", idxHasil+1, min)
...
print("Lokasi keberadaan jawaban di Iterasi {} Koloni {}".format(iter+1, kol+1))
